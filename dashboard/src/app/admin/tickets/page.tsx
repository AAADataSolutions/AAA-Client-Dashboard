    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-bold text-slate-900">{totalUrgent}</span>
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 mt-1">
              ...
              <span className="font-semibold text-rose-600">&lt; 1h SLA</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 mt-1">
              ...
              <span className="font-semibold text-amber-700">Verification</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm flex flex-col justify-between">
          ...
          <div className="mt-3">
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-bold text-slate-900">{totalResolved}</span>
            ...
            <div className="flex items-center justify-between text-xs text-slate-500 mt-1">
              ...
              <span className="font-semibold text-emerald-600">2.4h</span>
            </div>
          </div>
        </div>
      </div>
                ...
                filteredTickets.map((tkt) => (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      <div className="font-semibold text-slate-800">{tkt.property_name}</div>
                      <div className="text-[11px] text-indigo-600 font-semibold mt-0.5">{tkt.organization_name}</div>
                    </td>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-lg w-full p-6 my-8">
            <div className="flex items-center justify-between pb-4 border-b border-slate-200">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-slate-900">Create Support / Operational Ticket</h3>
              </div>
              <button
            ...
            <form onSubmit={handleCreateSubmit} className="mt-4 space-y-3.5 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-indigo-500 rounded-lg p-2 text-xs text-slate-900 outline-none"
                />
              </div>
          ...
          <div className="bg-white w-full max-w-2xl h-full shadow-2xl border-l border-slate-200 flex flex-col animate-in slide-in-from-right duration-200">
            ...
            <div className="p-6 border-b border-slate-200 bg-slate-50 flex items-start justify-between">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-slate-500 text-xs">{drawerTicket.organization_name}</span>
                </div>
                <h2 className="text-base font-bold text-slate-900 mt-1.5">{drawerTicket.subject}</h2>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 text-xs">
              ...
              <div className="grid grid-cols-3 gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200">
                <div>
                  ...
                  <select
                    ...
                    className="bg-white border border-slate-200 rounded px-2 py-1 font-semibold text-slate-800 outline-none mt-1 w-full"
                  >
                    <option value="OPEN">Open</option>
                    <option value="IN_PROGRESS">In Progress</option>
                    <option value="WAITING_ON_CLIENT">Waiting on Client</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="bg-white border border-slate-200 rounded px-2 py-1 font-semibold text-slate-800 outline-none mt-1 w-full"
                  >
                    <option value="Binoy (Super Admin)">Binoy (Super Admin)</option>
                    <option value="Alex Rivera (Support Lead)">Alex Rivera</option>
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-white space-y-1">
                ...
                <p className="text-slate-800 text-xs leading-relaxed">{drawerTicket.description}</p>
              </div>
                ...
                <div className="space-y-2.5">
                  {drawerTicket.comments.map((c) => (
                    ...
                    >
                      ...
                      <p className="text-slate-800 text-xs mt-2 leading-relaxed">{c.content}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <form onSubmit={handleAddComment} className="space-y-2.5 pt-2">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-700">Add Reply / Note</span>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:border-indigo-500 rounded-xl p-3 text-xs text-slate-900 outline-none"
                />
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#4338ca] hover:bg-[#3730a3] text-white font-semibold text-xs shadow-sm disabled:opacity-50"
                  >
