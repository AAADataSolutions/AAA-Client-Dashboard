    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-[#71717a] mt-0.5">
              Dedicated life safety lines, fire alarm communicator circuits, and emergency monitoring trunks.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <p className="text-xs text-slate-500 dark:text-[#71717a] max-w-md mt-1.5 leading-relaxed">
          No fireline circuits registered for your properties yet. Dedicated fire alarm and life-safety communication lines will be shown here.
        </p>
      </motion.div>
    </motion.div>
  );
