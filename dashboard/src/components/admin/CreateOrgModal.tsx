...
export const CreateOrgModal: React.FC<CreateOrgModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200 font-sans">
      <div className="fixed inset-0" onClick={createdInvite ? handleFinish : onClose} aria-hidden="true" />
      <div className="relative w-full max-w-xl bg-white dark:bg-[#15161c] border border-slate-200 dark:border-[#222430] rounded-2xl shadow-2xl p-6 z-10 space-y-5 animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-[#222430]">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-orange-50 dark:bg-orange-950/60 text-orange-600 dark:text-orange-400 flex items-center justify-center border border-orange-100 dark:border-orange-900/40">
          ...
          <div className="space-y-4 text-xs">
            <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/40 space-y-2 text-center">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-xs max-w-md mx-auto leading-relaxed">
                An invitation token was generated for <strong className="text-slate-900 dark:text-white font-mono">{createdInvite.email}</strong>. The client admin will set their own password upon opening.
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-slate-100 dark:bg-[#111217] border border-slate-200 dark:border-[#222430] rounded-lg text-slate-800 dark:text-slate-200 font-mono text-[11px] select-all"
                />
                <button
                  type="button"
                  onClick={handleCopyInvite}
                  className="px-3.5 py-2 rounded-lg bg-orange-600 hover:bg-orange-700 text-white font-semibold flex items-center gap-1.5 transition shadow-2xs cursor-pointer shrink-0"
                >
            ...
            <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-[#222430]">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1 text-slate-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-400 text-xs font-semibold"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-slate-50 dark:bg-[#111217] border border-slate-200 dark:border-[#222430] rounded-lg text-slate-900 dark:text-white focus:outline-hidden focus:ring-1 focus:ring-orange-500 text-xs"
                />
              </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-1.5">
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="City"
                      className="px-2.5 py-2 bg-slate-50 dark:bg-[#111217] border border-slate-200 dark:border-[#222430] rounded-lg text-slate-900 dark:text-white focus:outline-hidden focus:ring-1 focus:ring-orange-500 text-xs"
                    />
                    <input
                      type="text"
                      name="state"
            ...
            <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100 dark:border-[#222430]">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-4 py-2 rounded-lg bg-orange-600 hover:bg-orange-700 text-white font-semibold flex items-center gap-1.5 transition shadow-2xs disabled:opacity-50 cursor-pointer"
              >
                {submitting ? (
                  <>
