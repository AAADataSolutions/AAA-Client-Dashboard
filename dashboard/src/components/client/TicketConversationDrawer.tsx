                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {(ticket.attachments || []).map((att: any) => (
                        <div key={att.id} className="rounded-xl border border-slate-200 dark:border-[#2a2c3a] overflow-hidden bg-white dark:bg-[#111217]">
                          <div className="aspect-video bg-slate-100 dark:bg-[#1a1c24] relative">
                            {att.url ? (
                              <img src={att.url} alt={att.file_name} className="w-full h-full object-cover" />
                            ) : (
                              <div className="w-full h-full flex items-center justify-center">
